        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <h2 class="heading-section">Update Categories</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    ?>
                                    ...
                                    <?php endif ?>
                                    <form method="POST" class="contactForm" action="<?php echo url("admin/categories/update", ['categories_id' => $id]) ?>">
                                        <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div>
                                                        <input type="submit" value="Update categories" class="btn btn-primary"
                                                            id="btn">
